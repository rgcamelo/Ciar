        ...
        <td>
            ...
            <button type="button" class="btn btn-warning btn-lg" title="Enviar a Pares" data-toggle="modal" data-target="#pares{{$p->idsolicitud}}">
                ...
                <div class="modal fade" id="pares{{$p->idsolicitud}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                  ...
                  <button type="button" class="btn btn-danger btn-lg" title="Rechazar" data-toggle="modal" data-target="#reprobar{{$p->idsolicitud}}">
            ...
            @if ($p->estado == 'Calificado por Pares')
                    <button class="btn btn-success btn-lg" type="button" title="Aprobar" data-toggle="modal" data-target="#calificar{{$p->idsolicitud}}"><span class="fa fa-check"></span></button>
                    <button class="btn btn-danger btn-lg" type="button" title="No Aprobar" data-toggle="modal" data-target="#reprobar{{$p->idsolicitud}}"><span class="fa fa-close"></span></button>
