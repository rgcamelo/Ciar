            ...
            <div id="loginbox" style="margin-top:10px;" class="mainbox col-md-7 col-md-offset-2 col-sm-8 col-sm-offset-2">                    
                <div class="panel panel-info" >
                        ...
                        <div style="padding-top:30px" class="panel-body" >
                            ...
                            @endif
                            <form id="loginform" method="post" action="{{ url("/video") }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                                    {!! csrf_field() !!}
                                ...
                                <div style="margin-bottom: 25px" class="input-group {{ $errors->has('impacto') ? 'has-error' : ''}}">
                                            <span class="input-group-addon">Impacto</span>
                                            <select class="form-control" required name="impacto">
                                                 <option value="" selected></option>
